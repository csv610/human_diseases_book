...
\section{Overview}
Human metapneumovirus (hMPV) is a paramyxovirus closely related to respiratory syncytial virus (RSV), discovered in 2001, yet ubiquitous---virtually all children seroconvert by age 5. This condition affects many people worldwide and can range from mild to severe. Getting diagnosed promptly and starting the right treatment gives you the best outlook. Recognizing the condition early and managing it properly gives you the best chance for a good outcome. Understanding what causes this condition helps your doctor choose the right treatment for you. Learning about your condition and taking an active role in your care are key to managing it long term.

\section{Causes}
This condition happens because of hMPV infecting respiratory epithelium causing syncytia formation, ciliary dysfunction, airway obstruction, and inflammation. This condition develops from a combination of genetic and environmental factors that disrupt normal body processes. When these normal processes are disrupted, it leads to the symptoms and signs of the condition. Several factors can work together to trigger or make the condition worse. Knowing the specific cause helps your doctor choose the most effective treatment.
...
\begin{itemize}[noitemsep]
  \item Symptoms can range from mild URI to severe lower respiratory tract disease (bronchiolitis, croup, pneumonia)
  \item Severe disease is most common in premature infants, those with cardiopulmonary disease, and immunocompromised children.
...
\section{Diagnosis}
Doctors diagnose this using multiplex PCR.
...
\begin{itemize}[noitemsep]
  \item Treatment typically involves supportive care
  \item No licensed vaccine or specific antiviral therapy is available.
