...
\index{Inflammatory Breast Cancer}
...
\index{Invasive Lobular Carcinoma (ILC)}
...
\index{Lobular Carcinoma In Situ (LCIS)}
...
\index{Paget's Disease of the Nipple}
...
\index{Triple-Negative Breast Cancer (TNBC)}
