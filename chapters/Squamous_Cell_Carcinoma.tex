...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of squamous cell carcinoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include surgical removal, Mohs surgery for high-risk lesions, and radiation therapy for inoperable cases
  \item Cemiplimab (anti-PD-1) is approved for advanced cSCC.
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item In most cases, the outlook is favorable but worse than BCC
  \item Metastatic risk is higher in immunocompromised patients.
\end{itemize}
