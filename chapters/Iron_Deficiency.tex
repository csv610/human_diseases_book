...
\section{Causes}
This condition results from disruption of normal iron deficiency function.
...
\begin{itemize}[noitemsep]
  \item \item Clinical features manifest as microcytic hypochromic anemia including fatigue, pallor, weakness, shortness of breath on exertion, tachycardia, headache, and epithelial changes including koilonychia (spoon nails), glossitis, angular stomatitis, and pagophagia (pica for ice).
