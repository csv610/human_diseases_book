...
\begin{itemize}[noitemsep]
  \item Angina pectoris is chest discomfort caused by transient myocardial reduced blood flow without myocardial tissue death. Stable angina occurs predictably with exertion or emotional stress and is relieved by rest or nitroglycerin, reflecting fixed coronary atherosclerotic stenosis
  \item Unstable angina occurs unpredictably or at rest and represents acute coronary syndrome without troponin elevation
  \item Microvascular angina results from coronary microvascular dysfunction.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Treatment for stable angina includes antianginals (beta-blockers, calcium channel blockers, nitrates), risk factor modification, and revascularization when medical therapy is inadequate
  \item Unstable angina requires urgent antiplatelet therapy, anticoagulation, and early invasive strategy. Your outlook depends on the extent of coronary disease and risk factor control.
  \item Advanced age
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of angina pectoris require immediate medical evaluation
\end{itemize}
