...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of pulmonary embolism require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item The right treatment depends on severity: anticoagulation for hemodynamically stable disease
  \item Systemic thrombolysis, catheter-directed therapy, or surgical embolectomy for massive disease with hemodynamic instability
  \item Inferior vena cava filters are placed when anticoagulation is contraindicated.
\end{itemize}
