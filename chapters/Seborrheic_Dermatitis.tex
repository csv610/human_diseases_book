...
\begin{itemize}[noitemsep]
  \item Clinical features in adults include greasy, yellowish scales on an erythematous base, affecting the scalp (dandruff in mild form), eyebrows, nasolabial folds, and ears. 
  \end{itemize}
