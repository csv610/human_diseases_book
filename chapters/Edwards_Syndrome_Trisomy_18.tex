\chapter{Edwards Syndrome (Trisomy 18)}
...
\begin{itemize}[noitemsep]
  \item You may experience severe intellectual disability, growth restriction, low-set malformed ears, micrognathia, prominent occiput, clenched fists with overlapping fingers, rocker-bottom feet, and congenital heart disease. Median survival is less than 1 year
  \item Only 5--10\% survive to age 1 year.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of edwards syndrome (trisomy 18) require immediate medical evaluation
\end{itemize}
