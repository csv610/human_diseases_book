...
\section{Overview}
Yellow fever is a mosquito-borne involving bleeding fever caused by yellow fever virus (YFV), a flavivirus transmitted by \textit{Aedes} and \textit{Haemogogus} mosquitoes, with 200,000 cases and 30,000 deaths annually in tropical Africa and South America.
\section{Causes}
This condition happens because of the virus infecting dendritic cells, spreading to lymph nodes and liver, with hepatitis resulting from direct viral cytopathology of hepatocytes (midzonal tissue death, Councilman bodies), and the pathogenesis of bleeding including liver coagulopathy and thrombocytopenia.     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of yellow fever require immediate medical evaluation
\end{itemize}
