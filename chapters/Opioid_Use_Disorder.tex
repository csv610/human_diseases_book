...
\begin{itemize}[noitemsep]
  \item \item You may experience a problematic pattern of opioid use (heroin, prescription opioids) leading to clinically significant impairment, with criteria analogous to AUD. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of opioid use disorder require immediate medical evaluation
\end{itemize}
