...
\begin{itemize}[noitemsep]
  \item You may experience a problematic pattern of opioid use (heroin, prescription opioids) leading to clinically significant impairment, with criteria analogous to AUD. 
  \end{itemize}
