...
\begin{itemize}[noitemsep]
  \item This condition happens because of HCV infection, with approximately 75--85\% of acute cases progressing to chronic infection. Chronic hepatitis C follows an indolent course, with 10--20\% developing cirrhosis over 20--30 years
  \item Extrahepatic manifestations include cryoglobulinemia, membranoproliferative glomerulonephritis, and B-cell lymphoma.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hepatitis c require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item The WHO has set a goal of hepatitis C elimination by 2030.
\end{itemize}
