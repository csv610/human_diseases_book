...
\begin{itemize}[noitemsep]
  \item \item Clinical features typically manifest in adulthood and include liver cirrhosis (most common cause of morbidity), hepatocellular carcinoma (30\% risk with cirrhosis), skin hyperpigmentation (bronze diabetes), diabetes mellitus, hypogonadism, arthropathy (chondrocalcinosis), and cardiomyopathy.
...
\begin{itemize}[noitemsep]
  \item Treatment typically involves therapeutic phlebotomy (weekly until ferritin less than 50 ng/mL, then maintenance)
  \item Iron chelation is used if phlebotomy is contraindicated.
