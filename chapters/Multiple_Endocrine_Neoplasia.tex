...
\begin{itemize}[noitemsep]
  \item Your symptoms depend on the glands involved. Genetic testing guides prophylactic thyroidectomy in RET mutation carriers (within the first year of life for MEN2B, by age 5 for MEN2A). 
  \end{itemize}
