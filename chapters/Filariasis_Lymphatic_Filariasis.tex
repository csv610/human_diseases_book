\chapter{Filariasis (Lymphatic Filariasis)}
\index{Filariasis (Lymphatic Filariasis)}
\label{sec:Filariasis}

\section{Overview}
Lymphatic filariasis (elephantiasis) is a mosquito-borne nematode infection caused by \textit{Wuchereria bancrofti} (90\% of cases), \textit{Brugia malayi}, and \textit{B. timori}, with 120 million infected, primarily in tropical and subtropical regions, and is the second leading cause of permanent disability worldwide.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item \item You may experience asymptomatic microfilaremia (most infected individuals), acute filarial fevers (adenolymphangitis with painful lymphadenitis, fever, chills), and chronic manifestations (lymphedema of the leg, scrotal hydrocele, elephantiasis). Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of filariasis (lymphatic filariasis) require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item The outlook is good with early treatment
  \item Chronic lymphedema requires long-term care.
