\chapter{Retinopathy of Prematurity}
\index{Retinopathy of Prematurity}
\label{sec:Retinopathy of Prematurity}

\section{Overview}
Retinopathy of prematurity is a vasoproliferative retinal disease affecting premature infants, particularly those born before 32 weeks gestation with low birth weight.
\section{Causes}
This condition happens because of abnormal vascularization of the developing retina, which can lead to tractional retinal detachment and blindness.     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of retinopathy of prematurity require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item The outlook is good with timely screening and treatment
  \item Long-term follow-up is necessary due to risks of late sequelae including myopia, strabismus, and retinal detachment.
