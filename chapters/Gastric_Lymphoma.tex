...
\begin{itemize}[noitemsep]
  \item This condition happens because of \textit{H.~pylori}-driven lymphoproliferation
  \item High-grade (diffuse large B-cell) lymphoma may arise from low-grade MALT lymphoma or develop de novo.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of gastric lymphoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on \textit{H.~pylori} eradication therapy for low-grade MALT lymphoma
  \item Antibiotic-refractory or high-grade disease requires chemotherapy (R-CHOP) and/or radiation.
\end{itemize}
