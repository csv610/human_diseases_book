\chapter{Congenital Hip Dysplasia}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of congenital hip dysplasia require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Your doctor confirms the diagnosis with ultrasound (for infants <6 months) or radiography (for older infants). Treatment for infants under 6 months is a Pavlik harness to maintain hip flexion and abduction
  \item For older infants or failed Pavlik treatment, closed or open reduction with a spica cast is required.
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well with early treatment
  \item Untreated DDH leads to osteoarthritis and limb-length discrepancy.
\end{itemize}
