\chapter{Recurrent Pregnancy Loss}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of recurrent pregnancy loss require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Management addresses identified causes: surgical correction of uterine septum, anticoagulation for antiphospholipid syndrome, and thyroid hormone replacement for hypothyroidism
  \item For unexplained RPL, progesterone supplementation and supportive care are associated with improved outcomes.
