\chapter{Jet Lag Disorder}
\index{Jet Lag Disorder}
\label{sec:Jet Lag Disorder}

\section{Overview}
Jet lag disorder is a temporary circadian misalignment caused by rapid travel across multiple time zones.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item \item Symptoms include difficulty initiating or maintaining sleep at the destination bedtime, daytime fatigue, impaired thinking and memory performance, digestive tract disturbances, and general malaise. This condition happens because of the circadian system adapting at a rate of approximately one time zone per day. You may experience sleep disturbance and daytime impairment following rapid transmeridian travel. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of jet lag disorder require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Symptoms resolve as the circadian system adapts.
\end{itemize}
