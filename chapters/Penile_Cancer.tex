...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of penile cancer require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well for organ-confined disease
  \item 5-year survival drops to 50\% with nodal involvement.
\end{itemize}
