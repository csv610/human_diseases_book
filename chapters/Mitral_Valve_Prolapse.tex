\chapter{Mitral Valve Prolapse}
\index{Mitral Valve Prolapse}
...
\begin{itemize}[noitemsep]
  \item This condition happens because of structural abnormality of the mitral valve apparatus. Most patients are asymptomatic and discovered incidentally
  \item Clinical features may include palpitations, chest pain, and dysautonomic symptoms.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of mitral valve prolapse require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Most cases are idiopathic or associated with myxomatous deterioration
  \item Mitral valve prolapse is linked to Marfan syndrome and Ehlers-Danlos syndrome.
\end{itemize}
\section{Complications}
\begin{itemize}[noitemsep]
  \item Most people recover well in most cases
  \item Complications include mitral regurgitation, infective endocarditis, and rarely, arrhythmias.
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors diagnose this using echocardiography. Asymptomatic patients with minimal regurgitation require only reassurance
  \item Severe regurgitation may require surgical repair.
