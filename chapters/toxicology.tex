...
\index{Alcohol Intoxication and Withdrawal}
...
\index{Cannabis Toxicity and Cannabinoid Hyperemesis Syndrome}
...
\index{Stimulant Overdose (Cocaine, Methamphetamine)}
...
\index{Drowning (Submersion Injury)}
\label{sec:Drowning}
...
\index{Hydrogen Sulfide Toxicity}
...
\index{Methyl Parathion and Other Organophosphate Insecticides}
...
\index{Organophosphate and Carbamate Insecticide Poisoning}
...
\index{Radiation Sickness (Acute Radiation Syndrome)}
...
\index{Toxicokinetics and Toxicodynamics}
...
\index{Calcium Channel Blocker Overdose}
...
\index{SSRI Overdose and Serotonin Syndrome}
