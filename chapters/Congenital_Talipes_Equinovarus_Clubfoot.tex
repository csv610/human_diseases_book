\chapter{Congenital Talipes Equinovarus (Clubfoot)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of congenital talipes equinovarus (clubfoot) require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well with adherence to bracing
  \item Surgical release is reserved for resistant or neglected cases.
\end{itemize}
