...
\begin{itemize}[noitemsep]
  \item This condition happens because of HBV infection, with chronic infection defined by persistence of HBsAg for more than 6 months
  \item Chronic hepatitis B carries risks of cirrhosis (15--40\%) and hepatocellular carcinoma (2--5\% per year in cirrhotics).
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hepatitis b require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Symptoms of acute infection range from subclinical to fulminant liver failure
  \item The natural history follows a spectrum of immune tolerance, immune active phase, inactive carrier state, and reactivation.
\end{itemize}
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Outlook is improved with antiviral therapy
  \item Vaccination is highly effective in preventing infection.
