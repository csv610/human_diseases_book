\chapter{Tetanus (Clostridium tetani)}
...
\begin{itemize}[noitemsep]
  \item You may experience an incubation period of 3--21 days, with trismus (lockjaw) being the earliest sign in 75\% of cases, followed by risus sardonicus, opisthotonos, generalized muscle rigidity, and painful spasms triggered by minimal stimuli, with autonomic instability occurring in severe cases. Fever and chills Fatigue and malaise Localized pain and inflammation at infection site Swelling, redness, and warmth (local infection) Cough and respiratory symptoms (respiratory infections) Nausea, vomiting, and diarrhea (gastrointestinal infections) Headache and body aches Skin rash or lesions Enlarged lymph nodes Systemic symptoms in severe cases (hypotension, organ dysfunction)
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of tetanus (clostridium tetani) require immediate medical evaluation
\end{itemize}
