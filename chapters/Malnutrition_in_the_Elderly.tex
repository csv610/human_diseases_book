\chapter{Malnutrition in the Elderly}
\index{Malnutrition in the Elderly}
...
\begin{itemize}[noitemsep]
  \item \item You may experience weight loss, poor nutritional intake, and functional decline.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of malnutrition in the elderly require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Consequences include impaired immune function, delayed wound healing, muscle wasting, falls, and increased mortality.
\end{itemize}
