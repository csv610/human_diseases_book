...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of restless legs syndrome require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Outlook is chronic but manageable
  \item Augmentation is the most significant complication of dopaminergic therapy.
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors usually diagnose this based on your symptoms and a physical exam using the five essential IRLSSG diagnostic criteria
  \item Serum ferritin levels should be checked (goal >75 $\mu$g/L).
