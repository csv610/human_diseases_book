...
\begin{itemize}[noitemsep]
  \item \item You may experience chronic pelvic pain (dysmenorrhea, dyspareunia, chronic pelvic pain), infertility (present in 30--50\% of women with endometriosis), and cyclic symptoms. Diagnosis is typically made by laparoscopy with visualization of endometriotic implants and histological confirmation, with MRI useful for deep infiltrating endometriosis. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of endometriosis require immediate medical evaluation
\end{itemize}
