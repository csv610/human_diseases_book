...
\section{Causes}
This condition results from disruption of normal budd-chiari syndrome function.

\begin{itemize}[noitemsep]
  \item The most common cause is myeloproliferative tumors (particularly polycythemia vera)
  \item Other causes include antiphospholipid syndrome, paroxysmal nocturnal hemoglobinuria, and oral contraceptive use. This condition happens because of obstruction of liver venous outflow, leading to liver congestion, sinusoidal high blood pressure, and hepatocyte reduced blood flow.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Symptoms can range from asymptomatic to fulminant liver failure
  \item Classic features include acute abdominal pain, hepatomegaly, and ascites.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of budd-chiari syndrome require immediate medical evaluation
\end{itemize}
