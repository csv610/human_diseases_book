...
\begin{itemize}[noitemsep]
  \item This condition happens because of infection with hepatitis A virus (HAV), with an incubation period of 15--50 days. Most infections in children are asymptomatic
  \item Adults present with malaise, anorexia, nausea, vomiting, right upper quadrant pain, jaundice, and dark urine.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hepatitis a require immediate medical evaluation
\end{itemize}
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Treatment typically involves supportive, as no specific antiviral treatment exists
  \item Prevention is through vaccination (inactivated virus) and hygiene measures.
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well, as HAV does not cause chronic infection or cirrhosis
  \item Fulminant liver failure is rare (0.1--0.3\%).
\end{itemize}
