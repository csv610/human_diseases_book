...
\begin{itemize}[noitemsep]
  \item Clinical features typically include a solitary, firm, mobile, well-circumscribed, rubbery mass---often described as a ``breast mouse'' due to its mobility---which can grow during pregnancy or hormonal stimulation. 
  \end{itemize}
