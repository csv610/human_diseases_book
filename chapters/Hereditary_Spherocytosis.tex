...
\begin{itemize}[noitemsep]
  \item \item Symptoms can range from asymptomatic (compensated hemolysis) to severe hemolytic anemia with jaundice, splenomegaly, gallstones, and aplastic crisis (parvovirus B19 infection).
