...
\begin{itemize}[noitemsep]
  \item Symptoms often appear as rapid masseter muscle spasm (lockjaw), hypercapnia (rising end-tidal CO2, earliest and most sensitive sign), sinus tachycardia, muscle rigidity, severe mixed respiratory/metabolic acidosis, rhabdomyolysis (myoglobinuria), hyperkalemia, and late fulminant hyperthermia ($>42^\circ\mathrm{C}$). 
  \end{itemize}
