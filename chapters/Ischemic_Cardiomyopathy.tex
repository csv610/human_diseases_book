\chapter{Ischemic Cardiomyopathy}
\index{Ischemic Cardiomyopathy}
...
\begin{itemize}[noitemsep]
  \item Ischemic cardiomyopathy is myocardial dysfunction resulting from chronic reduced blood flow or prior heart attack, leading to progressive ventricular dilation and heart failure
  \item It is the most common cause of heart failure worldwide.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ischemic cardiomyopathy require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Coronary revascularization may improve outcomes in selected patients
  \item Advanced therapies include cardiac resynchronization therapy, implantable cardioverter-defibrillators, and cardiac transplantation.
\end{itemize}
