...
\begin{itemize}[noitemsep]
  \item \item You may experience persistent high fever, hepatosplenomegaly, lymphadenopathy, cytopenias (at least two lineages: anemia, thrombocytopenia, neutropenia), skin rash, and neurological symptoms (seizures, altered mental status, meningismus).
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hemophagocytic lymphohistiocytosis and macrophage activation syndrome require immediate medical evaluation
\end{itemize}
