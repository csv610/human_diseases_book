...
\begin{itemize}[noitemsep]
  \item \item You may experience difficulty sleeping in one's own bed but improved sleep in novel environments.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of psychophysiologic insomnia require immediate medical evaluation
\end{itemize}
