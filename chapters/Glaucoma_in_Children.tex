...
\begin{itemize}[noitemsep]
  \item You may experience epiphora, blepharospasm, photophobia, buphthalmos, and corneal swelling
  \item Juvenile open-angle glaucoma presents in older children and adolescents.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of glaucoma in children require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on early surgical intervention (goniotomy or trabeculotomy)
  \item Secondary childhood glaucoma may result from aphakia, trauma, uveitis, or steroids.
