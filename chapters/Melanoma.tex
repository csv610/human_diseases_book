...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of melanoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment for thin melanoma ($\leq$1 mm) is surgical removal with sentinel lymph node biopsy for those $\geq$0.8 mm or with ulceration
  \item Immunotherapy (anti-PD-1 [nivolumab, pembrolizumab], anti-CTLA-4 [ipilimumab], combination therapy) and targeted therapy (BRAF/MEK inhibitors for BRAF V600-mutated melanoma) have revolutionized treatment of advanced melanoma.
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item To make the diagnosis, doctors look for excisional biopsy with adequate margins
  \item Staging uses Breslow thickness, ulceration, mitotic rate, and lymph node status.
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Your outlook depends on stage at diagnosis
  \item Early detection is critical.
