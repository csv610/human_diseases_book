...
\begin{itemize}[noitemsep]
  \item \item You may experience bone pain (most commonly in lower back, hips, and legs), proximal muscle weakness, fractures, skeletal deformities, growth retardation in children, and extraosseous calcium buildup (vascular calcium buildup, calciphylaxis). Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of renal osteodystrophy require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Outlook is improved by early recognition and treatment
  \item Kidney osteodystrophy improves after successful kidney transplantation.
\end{itemize}
