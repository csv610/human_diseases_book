\chapter{Splenomegaly}
\index{Splenomegaly}
\label{sec:Splenomegaly}

\section{Overview}
Splenomegaly is enlargement of the spleen beyond its normal size (normally approximately 12 cm in length).
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Mild splenomegaly may be asymptomatic, while massive splenomegaly causes early satiety, left upper quadrant pain, and discomfort, with a firm, smooth spleen on palpation.
\end{itemize}

\subsection{Common symptoms}
\begin{itemize}[noitemsep]
  \item \item Your symptoms depend on the degree of enlargement
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of splenomegaly require immediate medical evaluation
\end{itemize}
