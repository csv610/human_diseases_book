...
\begin{itemize}[noitemsep]
  \item \item You may experience generalized tonic-clonic seizures in the setting of preeclampsia. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of eclampsia require immediate medical evaluation
\end{itemize}
