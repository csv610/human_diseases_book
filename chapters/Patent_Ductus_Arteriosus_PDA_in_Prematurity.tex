\chapter{Patent Ductus Arteriosus (PDA) in Prematurity}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of patent ductus arteriosus (pda) in prematurity require immediate medical evaluation
\end{itemize}
