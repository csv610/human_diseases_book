...
\begin{itemize}[noitemsep]
  \item \item You may experience constitutional symptoms (fever, weight loss, muscle pain, joint pain), mononeuritis multiplex (the most characteristic neurological manifestation), livedo reticularis, testicular pain, kidney artery involvement (kidney tissue death due to lack of blood supply, high blood pressure, but not glomerulonephritis---distinguishing PAN from microscopic polyangiitis), mesenteric reduced blood flow, and cutaneous manifestations (nodules, ulcers, gangrene). Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}
