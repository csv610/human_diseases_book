\chapter{Granulomatosis with Polyangiitis}
\index{Granulomatosis with Polyangiitis}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of granulomatosis with polyangiitis require immediate medical evaluation
\end{itemize}
