...
\begin{itemize}[noitemsep]
  \item This condition happens because of lymphoproliferation
  \item Hepatitis C virus infection is linked to SMZL in some cases. Hairy cell leukemia is another important splenic lymphoproliferative disorder characterized by the BRAF V600E mutation.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of splenic lymphoma require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Diagnosis typically involves bone marrow biopsy, flow cytometry, and CT imaging. Management varies by histology: splenectomy and/or rituximab for SMZL
  \item Cladribine or moxetumomab for hairy cell leukemia.
