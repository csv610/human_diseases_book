\chapter{Gastrointestinal Stromal Tumor}
...
\begin{itemize}[noitemsep]
  \item Symptoms can range from incidental discovery to GI bleeding, abdominal pain, or a palpable mass. Symptoms vary depending on the severity and extent of the condition Pain or discomfort in the affected area     \item Persistent lump or mass in the affected area
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of gastrointestinal stromal tumor require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on surgical removal for localized disease
  \item Imatinib (a tyrosine kinase inhibitor) is used for advanced, unresectable, or metastatic disease and as adjuvant therapy for high-risk removed tumors.
\end{itemize}
