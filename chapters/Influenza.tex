...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of influenza require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Influenza is an acute respiratory infection caused by influenza viruses (types A and B), belonging to the Orthomyxoviridae family
  \item Influenza A viruses are further classified by hemagglutinin and neuraminidase surface antigens, with antigenic drift causing seasonal epidemics and antigenic shift potentially causing pandemics.
\end{itemize}
\section{Complications}
\begin{itemize}[noitemsep]
  \item You may experience abrupt onset of fever, chills, muscle pain, headache, malaise, nonproductive cough, sore throat, and nasal congestion
  \item Complications include viral or secondary bacterial pneumonia, myocarditis, pericarditis, encephalopathy, myositis, and Reye's syndrome (in children given aspirin).
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Most people recover well for most patients
  \item Annual influenza vaccination is the most effective preventive measure.
