...
\begin{itemize}[noitemsep]
  \item You may experience exertional shortness of breath, fatigue, orthopnea, and atrial fibrillation
  \item Physical examination reveals a high-pitched holosystolic (pansystolic) murmur at the apex radiating to the left axilla, S3 gallop, and displaced hyperdynamic apical impulse.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of mitral regurgitation require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Primary (organic) MR results from intrinsic valve apparatus pathology, including mitral valve prolapse (myxomatous deterioration), infective endocarditis, or rheumatic heart disease
  \item Secondary (functional) MR results from left ventricular remodeling or dilation (ischemic or dilated cardiomyopathy) displacing papillary muscles.
\end{itemize}
