\chapter{Chronic Hypertension in Pregnancy}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of chronic hypertension in pregnancy require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include antihypertensives (labetalol, nifedipine, methyldopa) for BP $\ge$160/100 mmHg
  \item ACE inhibitors and ARBs are contraindicated in pregnancy due to fetotoxicity.
