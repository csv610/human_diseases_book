...
\begin{itemize}[noitemsep]
  \item \item Clinical features are nonspecific: jitteriness, irritability, lethargy, seizures, apnea, poor feeding, and hypothermia. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of neonatal hypoglycemia require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include early feeding, intravenous dextrose, and monitoring of glucose levels
  \item Persistent or severe hypoglycemia requires evaluation for hyperinsulinism, fatty acid oxidation disorders, and other metabolic diseases.
