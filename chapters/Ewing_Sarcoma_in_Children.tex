\chapter{Ewing Sarcoma in Children}
...
\begin{itemize}[noitemsep]
  \item Ewing sarcoma is the second most common cancerous bone tumor in children and adolescents (see \hyperref[ch:bones]{Chapter~26, Diseases of the Musculoskeletal System} for comprehensive coverage). Peak incidence is 10--20 years. It arises in the diaphysis of long bones and flat bones (pelvis, ribs). The hallmark is a t(11
  \item 22)(q24
  \item Q12) translocation producing the EWSR1-FLI1 fusion gene.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ewing sarcoma in children require immediate medical evaluation
\end{itemize}
