...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cerebral aneurysm require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors diagnose this using CT angiography, MR angiography, or digital subtraction angiography. Treatment for unruptured aneurysms may involve observation or prophylactic treatment depending on size, location, and patient factors
  \item Ruptured aneurysms require urgent surgical clipping or endovascular coiling.
