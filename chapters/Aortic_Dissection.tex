...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of aortic dissection require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Stanford Type A (ascending aorta) requires immediate emergency surgical repair
  \item Stanford Type B (descending aorta) is managed medically with IV beta-blockers (esmolol, labetalol) to control heart rate and blood pressure unless complications occur.
