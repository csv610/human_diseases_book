...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ebola virus disease require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include supportive care and two FDA-approved monoclonal antibody therapies: mAb114 (ansuvimab) and REGN-EB3. outlook: Zaire species 50--80\% mortality without treatment
  \item 33--50\% with supportive care and monoclonal antibodies.
