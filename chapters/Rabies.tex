...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of rabies require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item You may experience an incubation of 20--90 days, followed by a prodrome (fever, malaise, tingling or numbness at the bite site), then acute nervous system phase: furious rabies (80\%)---hydrophobia, aerophobia, agitated behavior, autonomic instability, hypersalivation, and seizures
  \item Or paralytic rabies (20\%)---ascending flaccid paralysis.
\end{itemize}
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Treatment typically involves supportive once symptoms develop
  \item Prevention through pre-exposure prophylaxis and post-exposure prophylaxis (immediate wound cleansing, HRIG, and rabies vaccine) is nearly 100\% effective if administered before symptom onset.
