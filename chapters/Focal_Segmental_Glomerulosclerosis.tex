...
\begin{itemize}[noitemsep]
  \item \item You may experience proteinuria (often nephrotic-range), hematuria, high blood pressure, and progressive kidney insufficiency.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of focal segmental glomerulosclerosis require immediate medical evaluation
\end{itemize}
