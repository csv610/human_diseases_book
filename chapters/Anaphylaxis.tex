...
\begin{itemize}[noitemsep]
  \item You may experience skin involvement (urticaria, angioedema, flushing in 80--90\%), respiratory compromise (laryngeal swelling, bronchospasm), cardiovascular collapse (hypotension, distributive shock), digestive tract symptoms (nausea, vomiting, diarrhea), and neurological symptoms (anxiety, altered consciousness). 
  \end{itemize}
