...
\begin{itemize}[noitemsep]
  \item \item Clinical features in children include rickets (defective mineralization of growing bone) with craniotabes, frontal bossing, delayed fontanelle closure, rachitic rosary, Harrison groove, bowing of the legs (genu varum), widened wrists and ankles, myopathy, and hypocalcemic tetany. In adults, osteomalacia presents with bone pain, proximal muscle weakness (waddling gait), and fragility fractures.
