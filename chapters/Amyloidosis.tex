...
\begin{itemize}[noitemsep]
  \item Your symptoms depend on the organs involved: AL amyloidosis commonly presents with nephrotic syndrome (kidney amyloidosis---most common presentation, 70\%), restrictive cardiomyopathy (heart failure with preserved ejection fraction, low-voltage QRS on ECG, thickened ventricular walls on echocardiography with a ``speckled'' appearance), hepatomegaly, peripheral and autonomic neuropathy, macroglossia (tongue enlargement---pathognomonic for AL), periorbital purple spots on the skin, and carpal tunnel syndrome. 
  \end{itemize}
