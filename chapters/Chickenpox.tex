...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of chickenpox require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Complications include secondary bacterial skin infections (Staphylococcus aureus, Streptococcus pyogenes), cerebellar loss of coordination, pneumonia (more severe in adults), and encephalitis
  \item VZV remains dormant in dorsal root ganglia and may reactivate as herpes zoster later in life.
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors usually diagnose this based on your symptoms and a physical exam, confirmed by Tzanck smear (multinucleated giant cells) or PCR of lesion fluid. Management in healthy children is supportive (antipruritics, cool compresses
  \item Aspirin is strictly contraindicated due to Reye syndrome)
  \item Oral acyclovir or valacyclovir is indicated for adolescents, adults, and immunocompromised patients.
