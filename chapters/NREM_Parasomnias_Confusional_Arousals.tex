\chapter{NREM Parasomnias: Confusional Arousals}
\index{NREM Parasomnias: Confusional Arousals}
...
\section{Causes}
This condition happens because of incomplete arousal from slow-wave sleep.    Protein aggregation and accumulation is a common mechanism in many neurodegenerative disorders.  Genetic mutations account for some neurological conditions, while others are sporadic or environmentally triggered.   
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors usually diagnose this based on your symptoms and a physical exam. Management addresses underlying sleep-disordered breathing and triggers
  \item Clonazepam may be used in severe cases.
