...
\begin{itemize}[noitemsep]
  \item This condition happens because of rapid infiltrative growth with microvascular growth and areas of tissue death
  \item The IDH-wildtype molecular profile is characteristic.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of glioblastoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item MGMT promoter methylation status predicts response to temozolomide
  \item Tumor-treating fields (TTFields) have shown incremental survival benefit.
