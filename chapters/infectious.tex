...
\index{Diphtheria (Corynebacterium diphtheriae)}
...
\index{Gas Gangrene (Clostridial Myonecrosis)}
...
\index{Pertussis (Whooping Cough)}
\label{sec:Pertussis}
...
\index{Tetanus (Clostridium tetani)}
\label{sec:Tetanus}
...
\index{Tuberculosis (Extrapulmonary)}
...
\index{Candidiasis (Invasive / Systemic)}
...
\index{African Trypanosomiasis (Sleeping Sickness)}
...
\index{Amebiasis (Entamoeba histolytica)}
\label{sec:Amebiasis}
...
\index{Filariasis (Lymphatic Filariasis)}
...
\index{Primary Amebic Meningoencephalitis (Naegleria fowleri)}
...
\index{Eastern Equine Encephalitis}
...
\index{Rocky Mountain Spotted Fever}
...
\index{Epstein-Barr Virus / Infectious Mononucleosis (Systemic Aspects)}
...
\index{Hantavirus Pulmonary Syndrome}
