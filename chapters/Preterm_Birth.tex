\chapter{Preterm Birth}
\index{Preterm Birth}
\label{sec:Preterm Birth}

\section{Overview}
Preterm birth is a perinatal condition defined as delivery before 37 weeks of gestation. It affects approximately 10\% of all pregnancies worldwide and is the leading cause of neonatal morbidity and mortality.
\section{Causes}
This condition happens because of multiple pathogenic pathways including infection, inflammation, and uteroplacental reduced blood flow.     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of preterm birth require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include antenatal corticosteroids (betamethasone) to accelerate fetal lung maturation, magnesium sulfate for neuroprotection, and transfer to a facility with a level III NICU
  \item Tocolysis may be used to delay delivery for corticosteroid administration.
