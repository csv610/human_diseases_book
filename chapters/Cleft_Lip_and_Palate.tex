\chapter{Cleft Lip and Palate}
\index{Cleft Lip and Palate}
\label{sec:Cleft Lip and Palate}

\section{Overview}
Cleft lip and palate are among the most common congenital anomalies (1 per 700 live births), resulting from failure of fusion of the maxillary and medial nasal processes (cleft lip) or the palatal shelves (cleft palate).
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item \item You may experience feeding difficulties, speech abnormalities, hearing loss, and dental anomalies. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cleft lip and palate require immediate medical evaluation
\end{itemize}
