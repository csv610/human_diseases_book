\chapter{Dementia with Lewy Bodies}
\index{Dementia with Lewy Bodies}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of dementia with lewy bodies require immediate medical evaluation
\end{itemize}
