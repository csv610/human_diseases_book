...
\begin{itemize}[noitemsep]
  \item \item You may experience angular stomatitis (cheilosis), glossitis (smooth, magenta-colored tongue), seborrheic dermatitis (nasolabial folds, scrotum, vulva), photophobia, corneal vascularization, and normocytic anemia.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of vitamin b2 (riboflavin) deficiency --- ariboflavinosis require immediate medical evaluation
\end{itemize}
