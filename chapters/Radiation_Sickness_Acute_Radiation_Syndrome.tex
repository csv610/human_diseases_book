\chapter{Radiation Sickness (Acute Radiation Syndrome)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of radiation sickness (acute radiation syndrome) require immediate medical evaluation
\end{itemize}
\section{Progression and Stages}
The condition may progress through different stages of severity over time. Early stages often involve mild or subtle symptoms that may be overlooked. Moderate stages involve more noticeable symptoms affecting daily function. Advanced stages may involve significant impairment and complications.

\begin{itemize}[noitemsep]
  \item Clinical phases: prodromal phase (0--48 hours): nausea, vomiting, diarrhea, anorexia
  \item Latent phase: transient symptom improvement
  \item Manifest illness phase depends on dose: hematopoietic syndrome (1--6 Gy): pancytopenia, infection, bleeding, anemia
  \item Digestive tract syndrome (6--10 Gy): severe diarrhea, fluid loss, mucosal tissue death, sepsis
  \item Cerebrovascular/cardiovascular syndrome (>10--20 Gy): hypotension, cerebral swelling, convulsions, coma, death.
\end{itemize}
