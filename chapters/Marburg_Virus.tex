...
\section{Overview}
Marburg virus disease is a severe involving bleeding fever caused by Marburg virus, a negative-sense RNA virus (genus \textit{Marburgvirus}), the only filovirus other than Ebola to cause human disease, with outbreaks in Africa, and the reservoir being the Egyptian fruit bat (\textit{Rousettus aegyptiacus}).
\section{Causes}
This condition happens because of identical Disease mechanism to Ebola virus---infection of dendritic cells, macrophages, and monocytes, profound immunosuppression, cytokine storm, endothelial dysfunction, and DIC.     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of marburg virus require immediate medical evaluation
\end{itemize}
