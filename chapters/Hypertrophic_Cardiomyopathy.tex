...
\index{Hypertrophic Cardiomyopathy}
...
\begin{itemize}[noitemsep]
  \item Hypertrophic cardiomyopathy is the most common inherited cardiovascular disease, affecting 1 in 500 individuals, characterized by asymmetric left ventricular enlargement (typically interventricular septum of 15 mm or greater) in the absence of other loading conditions
  \item It is a leading cause of sudden cardiac death in young athletes.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hypertrophic cardiomyopathy require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Septal ablation or myectomy is for refractory obstruction
  \item Implantable cardioverter-defibrillator is placed for high-risk patients.
