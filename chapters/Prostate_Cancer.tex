...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of prostate cancer require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Intermediate-risk disease doctors typically treat it with radical prostatectomy or radiation therapy
  \item High-risk and metastatic disease require multimodal therapy including androgen deprivation therapy (ADT), radiation, chemotherapy (docetaxel), and novel hormonal agents (abiraterone, enzalutamide).
