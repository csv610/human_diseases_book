...
\subsection{Barotrauma of the Ear}
\index{Barotrauma of the Ear}
\label{sec:Barotrauma of the Ear}
Ear barotrauma is tissue injury to the tympanic membrane and middle ear cavity caused by an uncompensated pressure differential between ambient atmospheric pressure and the air-filled middle ear space, occurring during rapid altitude changes (scuba diving descent, commercial aviation, blast injuries). The condition results from Eustachian tube dysfunction (occlusion due to upper respiratory infection, mucosal edema, or allergic rhinitis) preventing equalizer air flow into the middle ear. During ambient pressure increases, negative middle ear pressure draws the tympanic membrane inward, precipitating mucosal hyperemia, subepithelial hemorrhage, middle ear effusion, or tympanic membrane rupture. Clinical features present as sudden severe ear pain (otalgia), a sensation of ear fullness/pressure, conductive hearing loss, tinnitus, and occasionally vertigo or otorrhagia (bloody ear discharge). Otoscopy demonstrates tympanic membrane retraction, hemotympanum, or perforation. Management involves prevention (Valsalva maneuver, chewing, oral/nasal decongestants prior to flight/dive); acute traumatic perforations usually heal spontaneously, with surgical tympanoplasty reserved for persistent non-healing tears.
