...
\begin{itemize}[noitemsep]
  \item \item Clinical features may include microvascular symptoms (erythromelalgia, headache, visual disturbances), blood clot formation (arterial or venous), or bleeding (with very high platelet counts $>$1,000,000/$\mu$L due to acquired von Willebrand syndrome), though many patients are asymptomatic. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}
