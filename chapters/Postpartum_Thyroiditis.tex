\chapter{Postpartum Thyroiditis}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of postpartum thyroiditis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item You may experience a transient thyrotoxic phase (4--8 weeks, 30\% of cases) followed by a hypothyroid phase (4--12 weeks, 40\%), with 25\% remaining hypothyroid permanently. The thyrotoxic phase is managed symptomatically with beta-blockers (not antithyroid drugs)
  \item The hypothyroid phase doctors typically treat it with levothyroxine.
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Recurrence in subsequent pregnancies is common.
\end{itemize}
