...
\begin{itemize}[noitemsep]
  \item Neuroblastoma is the most common extracranial solid tumor in children and the most common malignancy in infants. It arises from the sympathetic nervous system, most commonly in the adrenal medulla (40\%) or paraspinal sympathetic chain. Incidence is 1 in 7000 children
  \item Median age at diagnosis is 18 months.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of neuroblastoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Intermediate-risk tumors receive chemotherapy
  \item High-risk tumors require intensive multimodal therapy. outlook ranges from excellent (>95\% survival in low-risk) to poor (40--50\% survival in high-risk).
