...
\section{Overview}
About 10\% of cases are familial, with mutations in SOD1, C9orf72, TARDBP, and FUS genes.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item You may experience focal muscle weakness, shrinkage or wasting, fasciculations, spasticity, and hyperreflexia
  \item Bulbar involvement causes slurred speech and difficulty swallowing.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of amyotrophic lateral sclerosis require immediate medical evaluation
\end{itemize}
