...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of invasive lobular carcinoma (ilc) require immediate medical evaluation
\end{itemize}
