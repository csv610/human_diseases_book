\chapter{Triple-Negative Breast Cancer (TNBC)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of triple-negative breast cancer (tnbc) require immediate medical evaluation
\end{itemize}
