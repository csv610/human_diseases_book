\chapter{Ductal Carcinoma In Situ (DCIS)}
\index{Ductal Carcinoma In Situ (DCIS)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ductal carcinoma in situ (dcis) require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on breast-conserving surgery (lumpectomy) with negative margins ($>2$ mm) followed by radiation therapy and adjuvant tamoxifen/aromatase inhibitors for ER-positive lesions
  \item Total mastectomy is indicated for widespread or multicentric disease.
