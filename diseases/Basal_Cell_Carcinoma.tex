...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of basal cell carcinoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item The right treatment depends on subtype, size, and location: surgical removal, Mohs micrographic surgery (for high-risk locations such as the face, with highest cure rate of 99\%), electrodesiccation and curettage (for superficial, low-risk lesions), and topical therapy (5-fluorouracil, imiquimod) for superficial BCC
  \item Vismodegib and sonidegib (Hedgehog pathway inhibitors) are used for advanced or metastatic BCC.
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Metastasis is extremely rare.
\end{itemize}
