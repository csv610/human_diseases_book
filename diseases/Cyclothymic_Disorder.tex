...
\begin{itemize}[noitemsep]
  \item You may experience chronic mood instability without meeting full criteria for hypomanic or depressive episodes. Symptoms vary depending on the severity and extent of the condition Pain or discomfort in the affected area Functional impairment affecting daily activities Changes in appearance or function of affected tissues Systemic symptoms may include fatigue, fever, or weight changes Symptoms may develop gradually or appear suddenly
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cyclothymic disorder require immediate medical evaluation
\end{itemize}
