...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of novel synthetic drugs require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment: aggressive sedation with benzodiazepines, active cooling, and supportive care
  \item Large doses of naloxone may be required for fentanyl analogs.
