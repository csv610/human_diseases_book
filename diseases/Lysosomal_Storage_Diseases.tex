...
\index{Lysosomal Storage Diseases}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of lysosomal storage diseases require immediate medical evaluation
\end{itemize}
\section{Progression and Stages}
The condition may progress through different stages of severity over time. Early stages often involve mild or subtle symptoms that may be overlooked. Moderate stages involve more noticeable symptoms affecting daily function. Advanced stages may involve significant impairment and complications.

\begin{itemize}[noitemsep]
  \item Fabry disease is an X-linked $\alpha$-galactosidase A deficiency causing accumulation of globotriaosylceramide, presenting with acroparesthesias, angiokeratomas, corneal verticillata, hypohidrosis, progressive kidney failure, hypertrophic cardiomyopathy, and stroke
  \item Enzyme replacement therapy and oral chaperone therapy slow disease progression.
\end{itemize}
