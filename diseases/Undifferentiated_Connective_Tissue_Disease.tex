...
\begin{itemize}[noitemsep]
  \item \item Clinical features are mild and often limited to a few domains: the most common are arthralgias or non-erosive arthritis (50--80\%), Raynaud's phenomenon (40--60\%), rash (malar-like or photosensitive), oral ulcers, sicca symptoms, serositis, and constitutional symptoms. Laboratory findings typically include a positive ANA (low-to-moderate titer, often speckled or homogeneous pattern). Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}
