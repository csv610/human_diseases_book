\chapter{Cholera (Vibrio cholerae)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cholera (vibrio cholerae) require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well with prompt rehydration (mortality $<$ 1\%)
  \item Without treatment, mortality exceeds 50\%.
\end{itemize}
