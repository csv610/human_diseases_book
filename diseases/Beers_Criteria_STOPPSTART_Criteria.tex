...
\section{Overview}
Two major tools guide prescribing in older adults. The \textbf{Beers Criteria} (American Geriatrics Society, updated 2023) lists potentially inappropriate medications (PIMs) to avoid or use with caution in older adults, including anticholinergics, benzodiazepines, Z-drugs, NSAIDs, sulfonylureas, and PPIs. The \textbf{STOPP/START criteria} are a European alternative that identifies PIMs (STOPP) and potential prescribing omissions (START---eg., missing statin in diabetes with cardiovascular disease, missing bisphosphonate after osteoporotic fracture). Both criteria reduce inappropriate prescribing and ADRs when integrated into clinical practice.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of beers criteria / stopp/start criteria require immediate medical evaluation
\end{itemize}
