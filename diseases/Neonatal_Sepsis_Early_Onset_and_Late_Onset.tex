\chapter{Neonatal Sepsis (Early-Onset and Late-Onset)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of neonatal sepsis (early-onset and late-onset) require immediate medical evaluation
\end{itemize}
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Treatment options include empiric broad-spectrum antibiotics and supportive care
  \item Preventative intrapartum antibiotic prophylaxis for GBS-colonized women has significantly reduced early-onset sepsis incidence.
