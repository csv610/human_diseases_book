...
\begin{itemize}[noitemsep]
  \item \item You may experience metabolic acidosis (proximal RTA), hypophosphatemic rickets/osteomalacia, polyuria, and growth retardation in children.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of fanconi syndrome require immediate medical evaluation
\end{itemize}
