...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of occipital neuralgia require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include nerve blocks with local anesthetic and corticosteroid (therapeutic and diagnostic), physical therapy, and medications (gabapentin, pregabalin, TCAs)
  \item For refractory cases, pulsed radiofrequency ablation or occipital nerve stimulation may be considered.
