...
\begin{itemize}[noitemsep]
  \item This condition happens because of the virus replicating in the respiratory epithelium and spreading hematogenously
  \item In congenital rubella, the virus infects the placenta and fetus during the first trimester, causing vasculitis and direct cellular damage.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of rubella require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well for postnatal rubella
  \item Congenital rubella syndrome causes permanent disability.
\end{itemize}
