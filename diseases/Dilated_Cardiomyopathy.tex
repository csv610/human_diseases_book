...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of dilated cardiomyopathy require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors diagnose this based on echocardiography showing a dilated left ventricle with reduced ejection fraction
  \item Endomyocardial biopsy may be indicated for suspected myocarditis.
...
\begin{itemize}[noitemsep]
  \item Management follows guideline-directed medical therapy for heart failure with reduced ejection fraction
  \item Anticoagulation may be considered for high thromboembolic risk
  \item Genetic counseling and family screening are recommended.
