...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of acute myeloid leukemia require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item 17) APL---favorable
  \item Inv(16), t(8
  \item 21)---favorable
  \item Complex karyotype, monosomy 5/7---unfavorable), and molecular studies (FLT3, NPM1, CEBPA, IDH1/2, TP53 mutations).
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on induction chemotherapy (cytarabine + anthracycline [``7+3''] or CPX-351 for secondary AML) followed by consolidation (cytarabine, allogeneic stem cell transplantation for intermediate/high-risk), with acute promyelocytic leukemia (APL, t(15
  \item 17), PML-RARA) treated with all-trans retinoic acid (ATRA) + arsenic trioxide with excellent cure rates ($>$90\%).
