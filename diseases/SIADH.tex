...
\section{Overview}
Syndrome of inappropriate antidiuretic hormone secretion (SIADH) is the most common cause of euvolemic hyponatremia, characterized by excessive ADH secretion despite normal or low plasma osmolality.
\section{Causes}
Causes include malignancies (small cell lung cancer most common, producing ectopic ADH), lung disorders (pneumonia, tuberculosis, aspergillosis), CNS disorders (meningitis, encephalitis, stroke, traumatic brain injury), and medications (SSRIs, TCAs, carbamazepine, vincristine, cyclophosphamide).     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of siadh require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include fluid restriction (first-line), pharmacotherapy (demeclocycline, vaptans/tolvaptan for refractory cases), and for severe symptomatic hyponatremia, cautious 3\% hypertonic saline with frequent sodium monitoring to avoid osmotic demyelination syndrome. outlook relates to the underlying cause
  \item SIADH itself resolves when the causative condition is treated.
