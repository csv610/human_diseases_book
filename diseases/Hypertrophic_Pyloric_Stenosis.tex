\chapter{Hypertrophic Pyloric Stenosis}
\index{Hypertrophic Pyloric Stenosis}
\label{sec:Hypertrophic Pyloric Stenosis}

\section{Overview}
Hypertrophic pyloric stenosis (HPS) is progressive thickening of the pyloric muscle causing gastric outlet obstruction. It occurs in 2--4 per 1000 live births, more commonly in males (4:1) and firstborn infants.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item You may experience presentation at 3--6 weeks of age with non-bilious, projectile vomiting after feeds
  \item Infants remain hungry after vomiting.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hypertrophic pyloric stenosis require immediate medical evaluation
\end{itemize}
