...
\begin{itemize}[noitemsep]
  \item You may experience fever, chills, foul-smelling vaginal discharge, lower abdominal pain, uterine tenderness, and signs of sepsis. Fever and chills Fatigue and malaise Localized pain and inflammation at infection site Swelling, redness, and warmth (local infection) Cough and respiratory symptoms (respiratory infections) Nausea, vomiting, and diarrhea (gastrointestinal infections) Headache and body aches Skin rash or lesions Enlarged lymph nodes Systemic symptoms in severe cases (hypotension, organ dysfunction)
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of septic abortion require immediate medical evaluation
\end{itemize}
