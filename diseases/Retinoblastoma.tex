...
\begin{itemize}[noitemsep]
  \item Retinoblastoma is the most common intraocular malignancy in children, with an incidence of 1 in 15,000--20,000 live births. It arises from primitive retinal cells and is caused by biallelic inactivation of the RB1 tumor suppressor gene. Retinoblastoma occurs in heritable (40\%) and non-heritable (60\%) forms
  \item Heritable retinoblastoma involves a germline RB1 mutation with younger age at presentation, bilateral involvement, and increased risk of second malignancies.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of retinoblastoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Survival exceeds 95\% in developed countries.
\end{itemize}
