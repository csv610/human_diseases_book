...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of gestational hypertension require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include close monitoring of blood pressure and fetal surveillance
  \item Antihypertensive therapy is initiated for persistent BP $\ge$160/105 mmHg using labetalol, nifedipine, or methyldopa.
...
\begin{itemize}[noitemsep]
  ...
  \item Blood pressure typically normalizes by 12 weeks postpartum, though approximately 25\% of women progress to preeclampsia.
\end{itemize}
