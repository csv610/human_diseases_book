...
\begin{itemize}[noitemsep]
  \item You may experience progressive spinal involvement leading to syndesmophyte formation, vertebral fusion ("bamboo spine"), and spinal rigidity
  \item Peripheral arthritis (hips, shoulders, knees), enthesitis (Achilles tendinitis, plantar fasciitis), anterior uveitis, and aortic regurgitation are associated features.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ankylosing spondylitis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include NSAIDs (first-line, used continuously), TNF inhibitors (adalimumab, etanercept, infliximab, certolizumab), and IL-17 inhibitors (secukinumab, ixekizumab) for inadequate response
  \item Physical therapy is essential.
...
\begin{itemize}[noitemsep]
  ...
  \item Early treatment improves outcomes.
\end{itemize}
