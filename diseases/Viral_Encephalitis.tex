...
\begin{itemize}[noitemsep]
  \item Viral encephalitis is an inflammation of the brain parenchyma caused by viral infection
  \item Herpes simplex virus type 1 (HSV-1) is the most common cause of sporadic fatal encephalitis, typically affecting the temporal and frontal lobes, while other causes include enteroviruses, arboviruses (West Nile, Japanese encephalitis), and varicella-zoster virus.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of viral encephalitis require immediate medical evaluation
\end{itemize}
