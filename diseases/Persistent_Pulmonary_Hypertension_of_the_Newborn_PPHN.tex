\chapter{Persistent Pulmonary Hypertension of the Newborn (PPHN)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of persistent pulmonary hypertension of the newborn (pphn) require immediate medical evaluation
\end{itemize}
