...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of mumps require immediate medical evaluation
\end{itemize}
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Mumps is an acute viral illness caused by mumps virus, a paramyxovirus, with 500,000 cases annually worldwide before widespread vaccination, now less common in vaccinated populations but with outbreaks in close-contact settings. Most people recover well
