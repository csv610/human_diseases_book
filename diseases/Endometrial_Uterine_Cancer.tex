\chapter{Endometrial / Uterine Cancer}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of endometrial / uterine cancer require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment for early-stage disease is total hysterectomy with bilateral salpingo-oophorectomy
  \item Progestin therapy may be used for fertility-sparing management. In most cases, the outlook is good: 5-year survival is 95\% for stage I disease.
\end{itemize}
