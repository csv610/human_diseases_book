...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of multiple myeloma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Risk stratification uses the International Staging System (ISS) and revised ISS (R-ISS), with del(17p), t(4
  \item 14), and t(14
  \item 16) as high-risk cytogenetic abnormalities.
\end{itemize}
