\chapter{Acute Lymphoblastic Leukemia (ALL) in Children}
...
\begin{itemize}[noitemsep]
  \item ALL is the most common childhood cancer (25\% of all pediatric malignancies) and the most common leukemia in children (see \hyperref[ch:blood]{Chapter~10, Diseases of the Blood} for comprehensive coverage). Peak incidence is 2--5 years. The majority of childhood ALL is B-cell precursor (B-ALL), and 25\% have the t(12
  \item 21) translocation (ETV6-RUNX1 fusion) which confers a favorable outlook.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of acute lymphoblastic leukemia (all) in children require immediate medical evaluation
\end{itemize}
