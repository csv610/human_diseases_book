...
\section{Causes}
This condition results from disruption of normal ehlers-danlos syndrome function.

\begin{itemize}[noitemsep]
  \item Classical EDS (cEDS) results from COL5A1/A2 mutations causing abnormal type V collagen
  \item Vascular EDS (vEDS) results from COL3A1 mutations causing abnormal type III collagen.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Symptoms vary depending on subtype: hEDS presents with joint hypermobility, skin hyperextensibility, easy bruising, chronic pain, and recurrent dislocations
  \item CEDS features velvety, hyperextensible skin, atrophic scars, and easy bruising
  \item VEDS presents with thin, translucent skin, characteristic facial appearance (prominent eyes, thin nose, lobeless ears), and life-threatening arterial, intestinal, or uterine rupture.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ehlers-danlos syndrome require immediate medical evaluation
\end{itemize}
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Outlook is normal for hEDS and cEDS
  \item VEDS has a median survival of 50 years, primarily due to arterial rupture.
\end{itemize}
