\chapter{Ambiguous Genitalia / Disorders of Sex Development}
\index{Ambiguous Genitalia / Disorders of Sex Development}
\label{sec:Ambiguous Genitalia}

\section{Overview}
Disorders of sex development (DSD) are congenital conditions in which the development of chromosomal, gonadal, or anatomic sex is atypical. Incidence is approximately 1 in 4500 live births.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item \item You may experience atypical genitalia at birth. Evaluation includes karyotype, hormone levels, imaging, and genitourinary anatomy assessment. Management requires a multidisciplinary team
...
\begin{itemize}[noitemsep]
  \item Salt-wasting congenital adrenal abnormal increase in cells is a life-threatening emergency requiring glucocorticoid and mineralocorticoid replacement.
\end{itemize}
