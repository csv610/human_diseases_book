\chapter{Patau Syndrome (Trisomy 13)}
...
\begin{itemize}[noitemsep]
  \item You may experience severe intellectual disability, microcephaly, holoprosencephaly, cleft lip and palate, polydactyly, low-set ears, microphthalmia, and congenital heart disease. Median survival is 3--10 days
  \item Less than 10\% survive to age 1 year.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of patau syndrome (trisomy 13) require immediate medical evaluation
\end{itemize}
