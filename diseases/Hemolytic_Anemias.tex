...
\index{Hemolytic Anemias}
\label{sec:Hemolytic Anemias}

\section{Overview}
Hemolytic anemias are a group of disorders characterized by premature destruction of red blood cells (RBCs), leading to anemia, elevated LDH, indirect hyperbilirubinemia (unconjugated), and reticulocytosis.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item You may experience fatigue, jaundice, dark urine, and splenomegaly. Symptoms vary depending on the severity and extent of the condition Pain or discomfort in the affected area Functional impairment affecting daily activities Changes in appearance or function of affected tissues Systemic symptoms may include fatigue, fever, or weight changes Symptoms may develop gradually or appear suddenly
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hemolytic anemias require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Enzyme disorders: G6PD deficiency, pyruvate kinase deficiency
  \item Hemoglobinopathies: sickle cell disease, thalassemia) or extrinsic (immune: autoimmune hemolytic anemia, hemolytic disease of the newborn
  \item Mechanical: microangiopathic hemolytic anemia in TTP/HUS, DIC, prosthetic valves
  \item Infectious: malaria, babesiosis).
\end{itemize}
