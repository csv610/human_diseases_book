\chapter{New Daily Persistent Headache}
...
\begin{itemize}[noitemsep]
  \item You may experience bilateral, pressing/tightening, moderate intensity pain
  \item The onset is clearly remembered by the patient (``a thunderclap headache that never went away'').
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of new daily persistent headache require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item The self-limiting subtype typically resolves within 2 years, while the refractory form causes significant disability.
\end{itemize}
