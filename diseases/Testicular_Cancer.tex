...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of testicular cancer require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment for stage I seminoma involves surveillance or adjuvant carboplatin
  \item Advanced disease doctors typically treat it with cisplatin-based chemotherapy (BEP---bleomycin, etoposide, cisplatin) with surgery for residual masses.
\end{itemize}
