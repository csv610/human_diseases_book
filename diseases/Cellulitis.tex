...
\begin{itemize}[noitemsep]
  \item You may experience a well-demarcated area of redness of the skin, warmth, swelling, tenderness, and sometimes lymphangitis and regional lymphadenopathy
  \item The lower extremities are most commonly affected.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cellulitis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Wound cultures and blood cultures may guide therapy in severe cases.
...
\section{Outlook}
\begin{itemize}[noitemsep]
  \item Most people recover well with appropriate antibiotic therapy
  \item Recurrent cellulitis may require prophylactic antibiotics.
\end{itemize}
