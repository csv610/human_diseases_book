\chapter{Congenital Diaphragmatic Hernia}
...
\begin{itemize}[noitemsep]
  \item \item Clinical features at birth include respiratory distress, scaphoid abdomen, and decreased breath sounds on the affected side.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of congenital diaphragmatic hernia require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include immediate endotracheal intubation (avoid bag-mask ventilation), nasogastric decompression, and gentle ventilation strategies
  \item Surgical repair is performed after physiologic stabilization. Overall survival is approximately 70--80\%.
