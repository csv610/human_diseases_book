...
\begin{itemize}[noitemsep]
  \item \item Symptoms often appear as unilateral, spontaneous, bloody (sanguineous) or serous single-duct nipple discharge, occasionally accompanied by a small subareolar palpable nodule. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of intraductal papilloma require immediate medical evaluation
\end{itemize}
