\chapter{Necrotizing Enterocolitis (NEC)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of necrotizing enterocolitis (nec) require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include bowel rest, nasogastric decompression, broad-spectrum antibiotics, and supportive care
  \item Surgical intervention is required for perforation or progressive disease.
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Mortality ranges from 20--50\%.
\end{itemize}
