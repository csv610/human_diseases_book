...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of dengue fever require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item You may experience incubation of 3--14 days, with classic dengue fever presenting with sudden onset high fever, severe headache (retro-orbital), joint pain and muscle pain (``breakbone fever''), maculopapular rash, lymphadenopathy, and leukopenia
  \item Severe dengue (dengue involving bleeding fever/dengue shock syndrome) presents with plasma leakage, severe thrombocytopenia, mucosal bleeding, and shock during the critical phase at defervescence.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Most people recover well for classic dengue
  \item Severe dengue has significant mortality without prompt supportive care.
