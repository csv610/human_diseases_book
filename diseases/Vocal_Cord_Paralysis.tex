...
\begin{itemize}[noitemsep]
  \item Vocal cord paralysis is a condition resulting from disruption of the recurrent laryngeal nerve, superior laryngeal nerve, or vagus nerve, with the most common cause being iatrogenic (thyroid surgery, thoracic and neck surgery)
  \item Other causes include tumors, stroke, viral infections, and idiopathic cause.
\end{itemize}
\section{Causes}
This condition happens because of nerve injury leading to loss of vocal fold movement.     
...
\begin{itemize}[noitemsep]
  \item Symptoms of unilateral paralysis include hoarseness, removal by suction, and a breathy voice
  \item Bilateral paralysis presents with stridor and respiratory distress.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of vocal cord paralysis require immediate medical evaluation
\end{itemize}
