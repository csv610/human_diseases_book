...
\begin{itemize}[noitemsep]
  \item Lung cancer is the leading cause of cancer-related death worldwide, with approximately 1.8 million deaths annually
  \item Non-small cell lung cancer accounts for 85\% of cases and includes adenocarcinoma (most common subtype, often in non-smokers, with driver mutations in EGFR, ALK, ROS1, KRAS), squamous cell carcinoma (central, strongly smoking-related), and large cell carcinoma
  \item Small cell lung cancer accounts for 15\%, is strongly associated with smoking, and has aggressive behavior with early metastasis.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of lung cancer require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment for early-stage disease is surgical removal with adjuvant chemotherapy
  \item Advanced disease doctors typically treat it with platinum-based chemotherapy, immunotherapy, and targeted therapy for driver mutations
  \item Small cell lung cancer doctors typically treat it with chemoradiation and prophylactic cranial irradiation.
\end{itemize}
