...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cervical cancer require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment for early-stage disease is radical hysterectomy with pelvic lymph node dissection or chemoradiation
  \item Advanced disease doctors typically treat it with concurrent chemoradiation and adjuvant chemotherapy.
\end{itemize}
