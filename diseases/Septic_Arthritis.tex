...
\begin{itemize}[noitemsep]
  \item You may experience acute joint pain, swelling, warmth, redness of the skin, and reduced range of motion, with systemic signs of infection (fever, chills). Fever and chills Fatigue and malaise Localized pain and inflammation at infection site Swelling, redness, and warmth (local infection) Cough and respiratory symptoms (respiratory infections) Nausea, vomiting, and diarrhea (gastrointestinal infections) Headache and body aches Skin rash or lesions Enlarged lymph nodes Systemic symptoms in severe cases (hypotension, organ dysfunction)
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of septic arthritis require immediate medical evaluation
\end{itemize}
