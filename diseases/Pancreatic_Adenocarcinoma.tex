\chapter{Pancreatic Adenocarcinoma}
\index{Pancreatic Adenocarcinoma}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of pancreatic adenocarcinoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Adjuvant chemotherapy (FOLFIRINOX or gemcitabine/capecitabine) improves survival. Metastatic disease doctors typically treat it with systemic chemotherapy
  \item Molecular profiling may identify targets for precision therapy (BRCA mutations, MSI-high tumors). outlook remains poor, with a 5-year survival of approximately 12\%.
