...
\begin{itemize}[noitemsep]
  \item This condition happens because of a dysregulated immune response to gut microbiota in genetically susceptible individuals
  \item Unlike Crohn's disease, it does not involve the small intestine (except for backwash ileitis in pancolitis) and does not cause transmural disease, strictures, or fistulas.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item You may experience bloody diarrhea, urgency, tenesmus, and abdominal cramping
  \item Extraintestinal manifestations similar to Crohn's disease include arthritis, redness of the skin nodosum, and primary sclerosing cholangitis (occurring in 2--5\% of UC patients).
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of ulcerative colitis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Doctors diagnose this based on colonoscopy with biopsies showing continuous inflammation, crypt abscesses, and mucosal ulceration
  \item Severity is classified as mild, moderate, or severe based on stool frequency, rectal bleeding, hemoglobin, and CRP.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include 5-aminosalicylates (mesalamine) for mild-moderate disease, corticosteroids for flares, immunomodulators, and biologics (anti-TNF, vedolizumab, ustekinumab, tofacitinib [JAK inhibitor])
  \item Acute severe UC is a medical emergency treated with IV corticosteroids, with colectomy for refractory disease.
...
\begin{itemize}[noitemsep]
  ...
  \item Total proctocolectomy is curative.
\end{itemize}
