...
\section{Causes}
This condition happens because of chronic hyperglycemia damaging retinal capillaries, causing vascular occlusion, non-perfusion, microaneurysms, hemorrhages, hard exudates, and cotton-wool spots (non-proliferative DR).     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of diabetic retinopathy require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include optimal glycemic control, anti-VEGF intravitreal injections for diabetic macular swelling, focal or grid laser photocoagulation, and panretinal photocoagulation for proliferative disease
  \item Regular screening is recommended for all diabetic patients.
