...
\begin{itemize}[noitemsep]
  \item You may experience unilateral burning, boring, or stabbing pain with ipsilateral autonomic features (conjunctival injection, lacrimation, nasal congestion, rhinorrhea, miosis, ptosis, eyelid swelling) and restlessness or agitation during attacks. Episodic cluster headache occurs in bouts with remission periods
  \item Chronic cluster headache has attacks for >1 year without remission.
  \item Pain or discomfort in the affected area
  \end{itemize}
\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of cluster headache require immediate medical evaluation
\end{itemize}
