\chapter{Amebiasis (Entamoeba histolytica)}
\index{Amebiasis (Entamoeba histolytica)}
\label{sec:Amebiasis}

\section{Overview}
Amebiasis is an intestinal and extraintestinal infection caused by \textit{Entamoeba histolytica}, a protozoan parasite, with 50 million symptomatic cases and 100,000 deaths annually worldwide, particularly in the Indian subcontinent, sub-Saharan Africa, and Central/South America.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item You may experience intestinal amebiasis: amoebic dysentery---bloody mucoid diarrhea (strawberry jelly stools), abdominal pain, tenesmus, and weight loss
  \item Extraintestinal amebiasis: amebic liver abscess---most common extraintestinal form with fever, right upper quadrant pain, and ``anchovy paste'' pus.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of amebiasis (entamoeba histolytica) require immediate medical evaluation
\end{itemize}
