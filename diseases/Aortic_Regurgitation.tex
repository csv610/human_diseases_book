\chapter{Aortic Regurgitation}
\index{Aortic Regurgitation}
...
\begin{itemize}[noitemsep]
  \item Aortic regurgitation is incompetence of the aortic valve allowing diastolic backflow of blood from the aorta into the left ventricle
  \item Causes include bicuspid aortic valve, endocarditis, aortic root dilation (Marfan syndrome, aortic dissection, high blood pressure), and rheumatic disease.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of aortic regurgitation require immediate medical evaluation
\end{itemize}
