\chapter{Headache Attributed to Intracranial Hypotension}
\index{Headache Attributed to Intracranial Hypotension}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of headache attributed to intracranial hypotension require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment typically involves conservative initially (bed rest, caffeine)
  \item Epidural blood patch is the The main treatment for persistent symptoms, with success rates of 80--90\%.
