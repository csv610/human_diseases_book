...
\begin{itemize}[noitemsep]
  \item Pericarditis is an inflammation of the pericardium, the fibrous sac surrounding the heart
  \item Acute pericarditis is the most common pericardial disease, with viral cause being most frequent (Coxsackievirus, echovirus, adenovirus, SARS-CoV-2). Other causes include bacterial infection, uremia, autoimmune diseases, malignancy, and post-MI (Dressler syndrome).
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of pericarditis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include NSAIDs (ibuprofen, aspirin) and colchicine for 3 months
  \item Corticosteroids are used for refractory or recurrent cases.
