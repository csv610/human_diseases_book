\chapter{Myofascial Pain Syndrome}
...
\begin{itemize}[noitemsep]
  \item You may experience regional pain (not widespread like fibromyalgia), with active trigger points causing spontaneous pain and latent trigger points painful only with palpation
  \item Common sites include the trapezius, levator scapulae, masseter, and gluteal muscles.
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of myofascial pain syndrome require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include trigger point injections (dry needling or with local anesthetic), spray and stretch, physical therapy, posture correction, and ergonomic modifications
  \item Botulinum toxin injections may be used for refractory cases.
