\chapter{Allergic Fungal Rhinosinusitis (AFRS)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of allergic fungal rhinosinusitis (afrs) require immediate medical evaluation
\end{itemize}
