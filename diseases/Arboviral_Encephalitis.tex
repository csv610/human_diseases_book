\chapter{Arboviral Encephalitis}
...
\begin{itemize}[noitemsep]
  \item Clinical features: incubation 5--15 days, with most infections being asymptomatic or mild febrile illness
  \item Neuroinvasive disease presents with fever, headache, seizures, altered mental status, and focal deficits. Case fatality rate is less than 1\%.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of arboviral encephalitis require immediate medical evaluation
\end{itemize}
