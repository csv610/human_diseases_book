...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of medulloblastoma require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include maximal surgical removal, craniospinal irradiation, and adjuvant chemotherapy
  \item Risk-adapted therapy aims to reduce long-term neurocognitive and endocrine sequelae in survivors.
