\chapter{Adjustment Disorder}
\index{Adjustment Disorder}
\label{sec:Adjustment Disorder}

\section{Overview}
Adjustment disorder is one of the most commonly diagnosed psychiatric conditions in medical settings, with prevalence of 5--20\% in outpatient mental health clinics and up to 12\% in hospitalized medical patients.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Once the stressor is removed, symptoms typically resolve within 6 months. Symptoms vary depending on the severity and extent of the condition Pain or discomfort in the affected area Functional impairment affecting daily activities Changes in appearance or function of affected tissues Systemic symptoms may include fatigue, fever, or weight changes Symptoms may develop gradually or appear suddenly
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of adjustment disorder require immediate medical evaluation
\end{itemize}
