...
\begin{itemize}[noitemsep]
  \item \item You may experience auricular chondritis (the most common presenting feature: painful, swollen, erythematous ears sparing the lobule), nasal chondritis (saddle nose deformity), laryngotracheal involvement (subglottic stenosis, hoarseness, stridor, airway collapse---the most life-threatening manifestation), costochondritis, and non-erosive seronegative arthritis, with ocular involvement (episcleritis, scleritis, uveitis) occurring in up to 60\%, audiovestibular involvement (conductive and sensorineural hearing loss, feeling of spinning) being common, and association with other autoimmune diseases (SLE, vasculitis, myelodysplastic syndrome) in 30\%. Pain or discomfort in the affected area    \item Pain or discomfort in the affected area
  \end{itemize}
