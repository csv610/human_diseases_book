...
\section{Causes}
This condition results from disruption of normal pituitary adenoma function.
...
\begin{itemize}[noitemsep]
  \item \item Your symptoms depend on hormone secretion and tumor size.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of pituitary adenoma require immediate medical evaluation
\end{itemize}
