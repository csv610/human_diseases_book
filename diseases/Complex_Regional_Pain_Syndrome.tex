...
\begin{itemize}[noitemsep]
  \item \item Clinical features are organized into four domains: sensory (allodynia, hyperalgesia), vasomotor (temperature asymmetry, skin color changes), sudomotor/swelling, and motor/trophic (decreased range of motion, weakness, tremor, dystonia).
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of complex regional pain syndrome require immediate medical evaluation
\end{itemize}
