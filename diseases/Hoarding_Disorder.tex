...
\section{Overview}
Hoarding disorder has a prevalence of 2--6\% in the general population, increasing with age (particularly in those over 55).
\section{Causes}
...
\begin{itemize}[noitemsep]
  ...
  \item In-home decluttering sessions).
