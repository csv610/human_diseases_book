\chapter{Age-Related Bone Loss}
\index{Age-Related Bone Loss}
...
\begin{itemize}[noitemsep]
  \item It affects 10--20\% of women over 50 and 4--5\% of men
  \item Prevalence increases steeply with age.
\end{itemize}
\section{Causes}
This condition happens because of an imbalance between bone resorption and bone formation, driven by estrogen deficiency, secondary hyperparathyroidism, decreased mechanical loading, and reduced anabolic hormone levels.     
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of age-related bone loss require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors diagnose this using dual-energy X-ray absorptiometry (DXA): a T-score of $\leq$-2.5 defines osteoporosis
  \item -1.0 to -2.5 defines osteopenia. The FRAX tool estimates 10-year fracture probability.
