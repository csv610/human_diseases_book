...
\begin{itemize}[noitemsep]
  \item Portal high blood pressure is defined as a liver venous pressure gradient (HVPG) of 5 mmHg or greater, with clinically significant portal high blood pressure at HVPG of 10 mmHg or greater
  \item The most common cause is cirrhosis.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of portal hypertension require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Your doctor confirms the diagnosis with HVPG measurement via right heart catheterization
  \item Non-invasive assessment includes platelet count, transient elastography, and endoscopy.
