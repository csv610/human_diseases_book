...
\index{Constrictive Pericarditis}
...
\begin{itemize}[noitemsep]
  \item Constrictive pericarditis is a condition in which the pericardium becomes thickened, fibrotic, and calcified, restricting diastolic filling of the heart
  \item Common causes include prior cardiac surgery, radiation therapy, tuberculosis, idiopathic pericarditis, and autoimmune disease.
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of constrictive pericarditis require immediate medical evaluation
\end{itemize}
