\chapter{Multiple Myeloma (Bone Manifestations)}
\index{Multiple Myeloma (Bone Manifestations)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of multiple myeloma (bone manifestations) require immediate medical evaluation
\end{itemize}
