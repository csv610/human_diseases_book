\chapter{Atrial Fibrillation in the Elderly}
\index{Atrial Fibrillation in the Elderly}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of atrial fibrillation in the elderly require immediate medical evaluation
\end{itemize}
