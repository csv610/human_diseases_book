...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of carpal tunnel syndrome require immediate medical evaluation
\end{itemize}
...
\section{Diagnosis}
\begin{itemize}[noitemsep]
  \item Doctors diagnose this based on clinical examination (Phalen's test, Tinel's sign) and nerve conduction studies confirming delayed median nerve conduction across the wrist. Management begins with wrist splinting (especially at night), ergonomic modifications, and corticosteroid injection
  \item Surgical carpal tunnel release is indicated for severe or refractory cases.
