...
\section{Causes}
This condition results from disruption of normal neonatal abstinence syndrome function.
...
\begin{itemize}[noitemsep]
  \item \item Clinical features develop within 24--72 hours of birth and include CNS irritability (high-pitched cry, tremors, hypertonia, seizures), autonomic dysfunction (sweating, fever, yawning, sneezing, mottling), and GI dysfunction (poor feeding, vomiting, diarrhea).
