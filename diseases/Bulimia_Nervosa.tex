...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of bulimia nervosa require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment options include CBT-E (first-line), IPT (second-line), and SSRI pharmacotherapy (high-dose fluoxetine 60 mg/day is FDA-approved). outlook: 50--60\% achieve recovery
  \item Relapse rates are moderate.
