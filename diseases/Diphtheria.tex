...
\begin{itemize}[noitemsep]
  \item You may experience a tough, gray-white pseudomembrane on the pharynx and tonsils, neck swelling (``bull neck''), fever, and toxic appearance
  \item The exotoxin can cause myocarditis and neuropathy.
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of diphtheria require immediate medical evaluation
\end{itemize}
