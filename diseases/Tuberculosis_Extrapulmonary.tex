\chapter{Tuberculosis (Extrapulmonary)}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of tuberculosis (extrapulmonary) require immediate medical evaluation
\end{itemize}
