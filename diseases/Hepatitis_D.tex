...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of hepatitis d require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Co-infection results in more severe acute hepatitis and a higher risk of fulminant liver failure than HBV alone
  \item Superinfection in chronic HBV carriers accelerates progression to cirrhosis and HCC.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on pegylated interferon-alpha with limited efficacy
  \item Bulevirtide has been approved in Europe as an entry inhibitor.
