...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of measles (rubeola) require immediate medical evaluation
\end{itemize}
...
Complications include pneumonia (most common cause of death), otitis media, laryngotracheobronchitis, encephalitis, and subacute sclerosing panencephalitis (SSPE).
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item Measles is a highly contagious vaccine-preventable viral illness caused by measles virus, a paramyxovirus, with 140,000 deaths globally in 2018, and one of the most contagious infectious diseases with a basic reproduction number ($R_0$) of 12--18. Most people recover well with supportive care
  \item Prevention through MMR vaccine is highly effective.
