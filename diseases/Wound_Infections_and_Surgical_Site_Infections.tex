...
\begin{itemize}[noitemsep]
  \item This condition happens because of bacterial inoculation during or after surgery
  \item Most SSIs are caused by \textit{S.~aureus} (including MRSA) and coagulase-negative staphylococci.
\end{itemize}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of wound infections and surgical site infections require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Wound cultures guide antibiotic therapy.
...
\section{Prevention}
\begin{itemize}[noitemsep]
  \item In most cases, the outlook is favorable with appropriate management
  \item Prevention strategies include appropriate antibiotic prophylaxis, skin preparation with chlorhexidine-alcohol, and aseptic technique.
...
\begin{itemize}[noitemsep]
  \item Treatment focuses on wound opening and removal of fluid for superficial SSIs, wound packing, and targeted antibiotic therapy
  \item Deep SSIs and organ/space infections may require surgical removal of dead tissue or reoperation.
