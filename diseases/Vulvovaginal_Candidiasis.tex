\chapter{Vulvovaginal Candidiasis}
\index{Vulvovaginal Candidiasis}
\label{sec:Vulvovaginal Candidiasis}

\section{Overview}
Vulvovaginal candidiasis (VVC) is a fungal infection caused by \textit{Candida} species, with \textit{Candida albicans} responsible for 80--90\% of cases.
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item You may experience intense vulvar itching, burning, vaginal soreness, dyspareunia, thick white ``cottage cheese'' discharge, vulvar redness of the skin, fissures, and swelling. Symptoms vary depending on the severity and extent of the condition Pain or discomfort in the affected area Functional impairment affecting daily activities Changes in appearance or function of affected tissues Systemic symptoms may include fatigue, fever, or weight changes Symptoms may develop gradually or appear suddenly
  \item Pain or discomfort in the affected area
  \end{itemize}

\subsection{Emergency warning signs}
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of vulvovaginal candidiasis require immediate medical evaluation
\end{itemize}
