...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of urosepsis require immediate medical evaluation
\end{itemize}
...
\begin{itemize}[noitemsep]
  ...
  \item Mortality ranges from 20--40\% depending on severity.
\end{itemize}
