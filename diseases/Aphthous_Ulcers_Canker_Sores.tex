\chapter{Aphthous Ulcers (Canker Sores)}
...
\begin{itemize}[noitemsep]
  \item Aphthous ulcers are recurrent, painful, shallow ulcers of the oral mucosa that affect up to 25\% of the population
  \item They are not contagious and are distinct from cold sores (herpes labialis).
\end{itemize}
\section{Causes}
...
\begin{itemize}[noitemsep]
  \item Severe or worsening symptoms of aphthous ulcers (canker sores) require immediate medical evaluation
\end{itemize}
